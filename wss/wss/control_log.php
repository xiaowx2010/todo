...
$where = "";
			...
			if($logtouser <> '0')
			{
				$where.= " csa_tb_backup2 = $coltouser AND";
			}
			
			if($logproject <> '0')
			{
				$where.= " csa_tb_backup3 = $colproject AND";
			}
...
$where ORDER BY csa_tb_year DESC" ;
...
<table width="100%" cellpadding="5">
  <tr>
  <td class="gray_bg"><a name="task"></a>
...
<?php echo $row_Recordset_log['task_status']; ?>
 &nbsp;&nbsp;
 <?php echo $row_Recordset_log['csa_tb_text']; ?>

  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="gray" ><?php echo $multilingual_user_view_project2; ?>: 
 <a href="project_view.php?recordID=<?php echo $row_Recordset_log['csa_project']; ?>">
  <?php echo $row_Recordset_log['project_name']; ?></a> &nbsp;&nbsp;<?php echo $multilingual_project_file_update; ?><?php echo $row_Recordset_log['csa_tb_lastupdate']; ?></span>
  </td>
  <td class="comment_list glink" width="60px" >
<script>	  
function addcomment<?php echo $row_Recordset_log['tbid']; ?>()
{
  ...
  <a href="#" onclick="addcomment<?php echo $row_Recordset_log['tbid']; ?>()"><?php echo $multilingual_log_comment; ?><?php 
