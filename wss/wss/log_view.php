...
<div style="width:100%; height:415px; overflow:auto;">
  <table align="center"  class="dialog_main glink">
    ...
    <tr valign="baseline">
      <td   align="left" class="dialog_left">
        <table width="560px" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="20%"><b><?php echo $multilingual_global_date; ?>:</b> 
              <?php
$logyear = str_split($logdate,4);
$logmonth = str_split($logyear[1],2);
?>
              <?php echo $logyear[0]; ?>-<?php echo $logmonth[0]; ?>-<?php echo $logmonth[1]; ?></td>
      <td align="right"><b><?php echo $multilingual_default_task_status; ?>:</b> &nbsp;</td>
      <td><?php echo $row_log['task_status_display']; ?></td>
      <td align="right"><b><?php echo $multilingual_default_task_manhour; ?>:</b> &nbsp;</td>
      <td align="left"><?php echo $row_log['csa_tb_manhour']; ?> <?php echo $multilingual_global_hour; ?></td>
    </tr>
        </table></td>
    </tr>
    <tr valign="baseline">
...
<div style="width:100%; text-align:right;">
	  ...
	  <?php if($_SESSION['MM_rank'] > "1") { ?>
	   <input type="button" onClick="javascript:self.location='comment_add.php?taskid=<?php echo $logid; ?>&date=<?php echo $logdate; ?>&tid=<?php echo $taskid; ?>&type=3';" value="<?php echo $multilingual_default_addcom; ?>" />
	  
	   <?php if ($_SESSION['MM_rank'] > "4" || $row_log['csa_tb_backup2'] == $_SESSION['MM_uid']) {  ?>
	  <input type="button" id="btn12" onclick="MM_goToURL('self','<?php echo "log_edit.php?date=".$logdate."&taskid=".$taskid; ?>');return document.MM_returnValue" value="<?php echo $multilingual_global_action_edit; ?>"/>
	  
	  
	  <input type="button" onClick="javascript:self.location='log_del.php?date=<?php echo $logdate; ?>&taskid=<?php echo $taskid; ?>';" value="<?php echo $multilingual_global_action_del; ?>" 
	   <?php if( $_SESSION['MM_Username'] == $multilingual_dd_user_readonly){
