...
// 输出Excel列名信息
$head = array("id","$multilingual_default_task_project","$multilingual_default_task_type","$multilingual_default_task_title","$multilingual_default_task_to","$multilingual_default_task_from","$multilingual_default_task_status","$multilingual_default_task_priority","$multilingual_default_tasklevel","$multilingual_default_task_planstart","$multilingual_default_task_planend","$multilingual_default_comment");
