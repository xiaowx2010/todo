...
<title>WSS -<?php echo $multilingual_head_user; ?></title>
...
<table class="rowcon" border="0" align="center">
  <tr>
    <td>
      <table>
        <tr>
          ...
          <td valign="top"><form id="form1" name="form1" method="get" action="default_user.php">
    ...
    <?php if ($_SESSION['MM_rank'] > "4") {  ?> <td valign="top" align="right"><input name="" type="button" onClick="javascript:self.location='user_add.php';" value="<?php echo $multilingual_user_new; ?>" class="button" />          </td>
    <?php }  ?>
  </tr>
</table>
<div class="taskdiv">
