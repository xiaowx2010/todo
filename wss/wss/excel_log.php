...
// 输出Excel列名信息
$head = array("id","$multilingual_user_view_user","$multilingual_user_view_by","$multilingual_user_view_do","$multilingual_user_view_taskname","$multilingual_user_view_project2","$multilingual_user_view_cost","$multilingual_user_view_status","$multilingual_project_file_update");
