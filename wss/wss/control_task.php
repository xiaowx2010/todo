...
<div class="condition">
  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="0" class="rowood">
  <tr>
  <td colspan="2">
  <span><b><?php echo $multilingual_outofdate_title; ?></b></span>
  </td>
  </tr>
  <tr>
    <td colspan="2">
     <div > 
    <table border="0" cellspacing="0" cellpadding="0" align="center"  width="100%" class="timeout_talbe" >
        <?php do { ?>
          <tr>
            <td class="oodtd" align="center"><?php echo $row_timeout['TID']; ?></td>
            <td class="oodtd">
			
			<a href="default_task_edit.php?editID=<?php echo $row_timeout['TID']; ?>" target="_parent">
			<b>[<?php echo $row_timeout['task_tpye']; ?>]</b> <?php echo $row_timeout['csa_text']; ?>			</a>			</td>
            <td  class="oodtd"><?php echo $multilingual_default_task_to; ?>: <a href="user_view.php?recordID=<?php echo $row_timeout['csa_to_user']; ?>" target="_parent"><?php echo $row_timeout['tk_display_name1']; ?></a></td>
            <!--<td class="oodtd"><?php echo $row_timeout['task_status_display']; ?></td>-->
            <!--<td class="oodtd"><?php echo $row_timeout['csa_plan_st']; ?></td>-->
            <!--<td class="oodtd"><?php echo $row_timeout['csa_plan_et']; ?></td>-->
            <!--<td class="oodtd"><?php echo $row_timeout['csa_priority']; ?></td>-->
            <!--<td class="oodtd"><?php echo $row_timeout['csa_temp']; ?></td>-->
			<td  class="oodtd">
			<span class="red"><img src="skin/themes/base/images/ood.gif">
			<?php 
  ...
  <table  border="0" cellspacing="0" cellpadding="0" align="center"  class="maintable tasktab_br" >
   <tbody>
    ...
    <tr>
      ...
      <th rowspan="2" width="53px" class="tasktab_height"><?php echo $multilingual_default_task_manhour; ?></th>
...
<div class="ui-widget"  style="margin-left:6px; margin-bottom:25px; margin-top:10px;">
