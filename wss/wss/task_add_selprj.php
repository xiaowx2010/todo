...
<?php if($section ==1){?>
<table align="center" class="glink" width="100%">
	...
	<?php do { ?>
	  ...
	  <a href="task_add_selprj.php?projectid=<?php echo $row_Recordset1['id']; ?>&section=2&UID=<?php echo $user_id; ?>&touser=<?php echo $touser; ?>
	  " class="icon_folder"><?php echo $row_Recordset1['project_name']; ?></a>
	  </div>
	  <div class="float_right">
	  <input name="" type="button" class="button" onclick="javascript:parent.parent.location='default_task_add.php?projectID=<?php echo $row_Recordset1['id']; ?>&UID=<?php echo $user_id; ?>&touser=<?php echo $touser; ?>';"  value="<?php echo $multilingual_project_newtask; ?>" />
	  </div>
</td>
    </tr>
...
<?php } else { ?>
<table align="center" class="glink" width="100%">
<tr><td class="pt_list"><a href="javascript:history.go(-1)"><b><?php echo $multilingual_taskadd_back; ?></b></a></td></tr>
	<?php if($totalRows_Recordset_subtask > "0"){?>
	<?php do { ?>
		<tr valign="baseline">
      <td  class="pt_list">
	  <div class="float_left">
	  <a href="task_add_selprj.php?taskid=<?php echo $row_Recordset_subtask['TID']; ?> &section=3&UID=<?php echo $user_id; ?>&touser=<?php echo $touser; ?>
	  " class="icon_file"><?php echo $row_Recordset_subtask['csa_text']; ?></a>
	  </div>
	  <div class="float_right">
	  <input name="" type="button" class="button" onclick="javascript:parent.parent.location='default_task_add.php?taskID=<?php echo $row_Recordset_subtask['TID']; ?>&projectID=<?php echo $row_Recordset_subtask['csa_project']; ?>&wbsID=<?php echo $wbsID; ?>&UID=<?php echo $user_id; ?>&touser=<?php echo $touser; ?>';" value="<?php echo $multilingual_project_newtask; ?>" />
	  </div>
</td>
    </tr>
