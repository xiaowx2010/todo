...
$taskurl = "<a href='".$host_url."default_task_edit.php?editID=".$taskid."'>".$title."</a>";


if ( $mail_service_update == "on" ){
wss_post_office($mailto, $user." $multilingual_user_updatetask".$title, $user." $multilingual_user_updatetask ".$taskurl); }
...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><?php echo $multilingual_default_task_manhour; ?>:</td>
      <td>
    ...
    <tr valign="baseline" >
      ...
      <td><textarea name="csa_tb_text" id="csa_tb_text"><?php echo $row_log['csa_tb_text']; ?></textarea>
      <input type="text" name="csa_tb_time" id="csa_tb_time" value="<?php echo date("Y-m-d H:i:s"); ?>" size="32" style="display:none;" />	  </td>
    </tr>
