...
CREATE TABLE IF NOT EXISTS `tk_task` (
  ...
  `csa_remark8` varchar(60) NOT NULL,
...
INSERT INTO `tk_user` (`uid`, `tk_user_login`, `tk_user_pass`, `tk_display_name`, `pid`, `tk_user_status`, `tk_user_registered`, `tk_user_remark`, `tk_user_rank`, `tk_user_contact`, `tk_user_email`, `tk_user_backup1`) VALUES
(1, 'admin', 'a6ec5a7b854d204b74cd90a8306a957e', 'Admin', 1, '管理员', '2012-11-08 08:12:00', '', 5, '', '', '');
