...
function Node(id, pid, name, url, title, target, icon, iconOpen, open,titlestyle) {
...
function dTree(objName) {
	...
	this.icon = {
		...
		root				: 'TreeImages/folder.gif',//base
...
dTree.prototype.add = function(id, pid, name, url, title, target, icon, iconOpen, open,titlestyle) {

	this.aNodes[this.aNodes.length] = new Node(id, pid, name, url, title, target, icon, iconOpen, open,titlestyle);
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (node.url) {
		...
		if(node._hc)
		{
			str+='onclick="javascript:  ' + this.obj + '.o(' + nodeId + '); ' + this.obj + '.s(' + nodeId + ');"';
		}
	...
	str += "<span style=\""+node.titlestyle+"\">"+node.name+"</span>";
